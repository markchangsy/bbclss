...
class ResNet18(nn.Module):
    ...
    def __init__(self, dataset):
        ...
        self.model = resnet18(pool='avgpool', pretrained=True)
        self.model.fc = nn.Linear(512, num_classes)

    def forward(self, audio):
        aud = self.model(audio)
        return aud
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=309, pool = 'avgpool',zero_init_residual=False,
